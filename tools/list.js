...
function replaceRequestCode() {
  let code = getFileContent(path.join(listPath, 'user_request.js'));
...
function replaceMockServiceCode() {
  ...
  fs.copyFileSync(path.join(listPath, 'user_mock.js'), mockServiceCodePath);
...
function main() {
  ...
  replaceCode(path.join(listPath, 'user.js'), modulePath + '.js');
  replaceCode(path.join(listPath, 'user.less'), modulePath + '.less');
  replaceCode(path.join(listPath, 'user_model.js'), path.join(modelsPath, modelName + '.js'));
