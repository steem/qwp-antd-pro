...
function qwp_render_page() {
    ...
    global $USER, $OP, $PAGE, $TEMPLATE_PATH, $MODULE_FILE, $MODULE;
    global $MODULE_ROOT, $MODULE_URI, $MODULE_BASE_PATH, $IS_APP_SETTING_REQ;
...
function qwp_is_valid_just_service_mode() {
    global $OP;

    return QWP_JUST_SERVICE && $OP;
}
function qwp_is_global_app_settings_request() {
    global $MODULE, $OP, $IS_APP_SETTING_REQ;
